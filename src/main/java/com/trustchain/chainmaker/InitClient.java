...
public class InitClient {
    static final String CLIENT1_KEY_PATH = "crypto-config-fabric/public/user/admin1/admin1.sign.key";
    static final String CLIENT1_CERT_PATH = "crypto-config-fabric/public/user/admin1/admin1.sign.crt";
    static String CLIENT1_TLS_KEY_PATH = "crypto-config-fabric/public/user/admin1/admin1.tls.key";
    static String CLIENT1_TLS_CERT_PATH = "crypto-config-fabric/public/user/admin1/admin1.tls.crt";
